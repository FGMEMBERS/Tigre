...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/tigre/state");
var engine = props.globals.getNode("sim/model/tigre/engine");
...
var turbine = props.globals.getNode("sim/model/tigre/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/tigre/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/tigre/rotor-step-deg");
